...
- `docs/memory/UI_REFERENCE_MAP.md（图5）`
- `docs/agents/C5_ROLE.md`
- `docs/threads/C1/HANDOFF.md`
- `docs/threads/C4/HANDOFF.md`
- 本线程：`docs/agents/C5_ROLE.md`
- 本线程记忆：`docs/threads/C5/STATUS.md` 等

## 4. 上游线程 HANDOFF
C1 + C4 HANDOFF

## 5. 允许修改目录
src/pages/storyboard/, src/components/storyboard/
...
## 10. 跨模块问题
写入 `docs/threads/C5/REQUESTS.md`（RFC 模板），等待 C0 决策。  
禁止直接改公共协议或他人目录。
...
## 12. 必须更新的线程记忆文件
- `docs/threads/C5/STATUS.md`
- `docs/threads/C5/HANDOFF.md`
- `docs/threads/C5/CHANGELOG.md`
- `docs/threads/C5/REQUESTS.md`（如有）
