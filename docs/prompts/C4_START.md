...
- `docs/memory/UI_REFERENCE_MAP.md（图4）`
- `docs/agents/C4_ROLE.md`
- `docs/threads/C1/HANDOFF.md`
- 本线程：`docs/agents/C4_ROLE.md`
- 本线程记忆：`docs/threads/C4/STATUS.md` 等

## 4. 上游线程 HANDOFF
docs/threads/C1/HANDOFF.md（可读 C2/C3 输出）

## 5. 允许修改目录
src/pages/script-editor/, src/components/script/
...
## 7. 必须完成的功能
- A/B/C 脚本版本切换
- Hook/Body/Proof/CTA/Disclaimer 编辑
- 事实引用 C1—C8
- Mock 生成 + loading
- 风险与可说性评分
- 进入分镜入口
...
## 10. 跨模块问题
写入 `docs/threads/C4/REQUESTS.md`（RFC 模板），等待 C0 决策。  
禁止直接改公共协议或他人目录。
...
## 12. 必须更新的线程记忆文件
- `docs/threads/C4/STATUS.md`
- `docs/threads/C4/HANDOFF.md`
- `docs/threads/C4/CHANGELOG.md`
- `docs/threads/C4/REQUESTS.md`（如有）
