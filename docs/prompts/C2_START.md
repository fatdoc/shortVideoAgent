...
- `docs/memory/UI_REFERENCE_MAP.md（图1/图2）`
- `docs/agents/C2_ROLE.md`
- `docs/threads/C1/HANDOFF.md`
- 本线程：`docs/agents/C2_ROLE.md`
- 本线程记忆：`docs/threads/C2/STATUS.md` 等

## 4. 上游线程 HANDOFF
docs/threads/C1/HANDOFF.md

## 5. 允许修改目录
src/pages/dashboard/, src/pages/brief/, src/components/project/
...
## 10. 跨模块问题
写入 `docs/threads/C2/REQUESTS.md`（RFC 模板），等待 C0 决策。  
禁止直接改公共协议或他人目录。
...
## 12. 必须更新的线程记忆文件
- `docs/threads/C2/STATUS.md`
- `docs/threads/C2/HANDOFF.md`
- `docs/threads/C2/CHANGELOG.md`
- `docs/threads/C2/REQUESTS.md`（如有）
