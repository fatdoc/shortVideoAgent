...
- `docs/agents/C7_ROLE.md`
- `docs/threads/C2/HANDOFF.md`
- `docs/threads/C3/HANDOFF.md`
- `docs/threads/C4/HANDOFF.md`
- `docs/threads/C5/HANDOFF.md`
- `docs/threads/C6/HANDOFF.md`
- 本线程：`docs/agents/C7_ROLE.md`
- 本线程记忆：`docs/threads/C7/STATUS.md` 等

## 4. 上游线程 HANDOFF
C2—C6 HANDOFF

## 5. 允许修改目录
src/tests/, tests/, docs/threads/C7/, docs/tasks/DEMO_CHECKLIST.md

## 6. 禁止修改目录
擅自重写业务页面；SHARED_MEMORY；domain 协议
- 禁止修改 `UI/**`
...
## 10. 跨模块问题
写入 `docs/threads/C7/REQUESTS.md`（RFC 模板），等待 C0 决策。  
禁止直接改公共协议或他人目录。
...
## 12. 必须更新的线程记忆文件
- `docs/threads/C7/STATUS.md`
- `docs/threads/C7/HANDOFF.md`
- `docs/threads/C7/CHANGELOG.md`
- `docs/threads/C7/REQUESTS.md`（如有）
