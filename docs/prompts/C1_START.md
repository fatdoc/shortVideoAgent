...
- `docs/agents/C1_ROLE.md`
- `docs/tasks/FILE_OWNERSHIP.md`
- `docs/tasks/ACCEPTANCE.md`
- 本线程：`docs/agents/C1_ROLE.md`
- 本线程记忆：`docs/threads/C1/STATUS.md` 等

## 4. 上游线程 HANDOFF
C0 Gate 0 报告（docs/tasks/GATE_0_REPORT.md）

## 5. 允许修改目录
src/app/, src/layouts/, src/design/, src/components/common/, src/domain/, src/stores/, src/services/, src/mocks/, 必要配置文件

## 6. 禁止修改目录
业务页完整实现；SHARED_MEMORY；UI 参考图；其他线程业务目录
- 禁止修改 `UI/**`
...
## 7. 必须完成的功能
- 确保 npm run dev 可启动
- 完善 AppShell/Sidebar/Topbar 与设计 token
- 六个路由占位可访问，并与统一 Demo 打通
- Zustand + LocalStorage + mockApi 可用
- 公共 Loading/Empty/Error/ErrorBoundary 可用
- 补充必要基座测试
...
## 10. 跨模块问题
写入 `docs/threads/C1/REQUESTS.md`（RFC 模板），等待 C0 决策。  
禁止直接改公共协议或他人目录。
...
## 12. 必须更新的线程记忆文件
- `docs/threads/C1/STATUS.md`
- `docs/threads/C1/HANDOFF.md`
- `docs/threads/C1/CHANGELOG.md`
- `docs/threads/C1/REQUESTS.md`（如有）
